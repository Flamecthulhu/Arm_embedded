...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(GY_SCL_GPIO_Port, GY_SCL_Pin);

    HAL_GPIO_DeInit(GY_SDA_GPIO_Port, GY_SDA_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI3)
  {
    ...
    PC10     ------> SPI3_SCK
    */
    HAL_GPIO_DeInit(EP_SDA_GPIO_Port, EP_SDA_Pin);

    HAL_GPIO_DeInit(EP_SCK_GPIO_Port, EP_SCK_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==UART7)
  {
    ...
    PE8     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOE, WL_RX_Pin|WL_TX_Pin);
...
/* SAI1 */
    ...
    PE6     ------> SAI1_SD_A
    */
    HAL_GPIO_DeInit(GPIOE, SAI_FS_Pin|SAI_SCK_Pin|MIC_SD_Pin);
    ...
    PE3     ------> SAI1_SD_B
    */
    HAL_GPIO_DeInit(SP_IN_GPIO_Port, SP_IN_Pin);
